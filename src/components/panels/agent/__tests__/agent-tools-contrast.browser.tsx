...
describe('Agent tool information text contrast', () => {
  // 默认（light）皮肤 2026-09-18 起改为纯白冷灰 + 科技蓝语义色；paper 沿用墨色一套。
  it.each([
    ['light', 'rgb(22, 101, 52)', 'rgb(185, 28, 28)', 'rgb(133, 77, 14)', 'rgb(15, 17, 21)', 'rgb(21, 128, 61)', 'rgb(239, 68, 68)', 'rgb(245, 158, 11)', 'rgb(255, 255, 255)'],
