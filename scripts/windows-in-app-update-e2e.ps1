...
try {
  ...
  Assert-E2eCondition -Condition ($plan.officialRepository.owner -eq 'poluce' -and $plan.officialRepository.repo -eq 'AI-Novel-Writer') -Message 'Release plan is not pinned to the official repository.'
